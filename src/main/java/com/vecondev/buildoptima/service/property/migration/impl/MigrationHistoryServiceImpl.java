...
public class MigrationHistoryServiceImpl implements MigrationHistoryService {
  ...
  @Override
  public MigrationHistory saveSucceededHistory(String filePath) {
    return save(filePath, null, null);
  }

  @Override
  public MigrationHistory saveFailedHistory(String filePath, String failedReason) {
    return save(filePath, failedReason, Instant.now());
  }
  ...
  private MigrationHistory save(String filePath, String failedReason, Instant failedAt) {
