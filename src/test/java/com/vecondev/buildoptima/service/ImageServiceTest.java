...
//      when(s3ConfigProperties.getImagePath(any())).thenReturn(ORIGINAL_IMAGES_PATH);
//      when(s3ConfigProperties.getImagePath(any())).thenReturn(THUMBNAIL_IMAGES_PATH);
//      imageService.uploadImagesToS3(any(),userId, null, new AppUserDetails(any()));
//    }
//
